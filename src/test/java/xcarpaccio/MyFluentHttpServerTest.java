...
public class MyFluentHttpServerTest {
    ...
    @Test public void
    shouqsfld_post_an_order() {
        given().
                contentType(JSON).
                body("{\"prices\":[86.15,85.52,86.39,11.19],\"quantities\":[9,5,1,6],\"country\":\"Llanfairpwllgwyngyllgogerychwyrndrobwllllantysiliogogogoch\",\"reduction\":\"STANDARD\"}").
        when().
                post("/order").
        then().
                statusCode(400).
